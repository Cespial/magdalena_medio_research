...
LULC_COLORS = {
    ...
    4: '#ff8c00',  # Crops - orange (rarely used)
    5: '#3690c0',  # Water - blue
    6: '#878787',  # Urban - gray
    7: '#a6611a',  # Bare soil - brown (rarely used)
}
...
# Active classes (5-class system after dropping zero-area classes)
ACTIVE_CLASSES = [1, 2, 3, 5, 6]
