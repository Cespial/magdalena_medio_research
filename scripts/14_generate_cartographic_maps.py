...
CITIES = {
    'Bogotá': (-74.1, 4.6),
    'Medellín': (-75.6, 6.25),
    'Bucaramanga': (-73.1, 7.1),
}

# Municipality labels
MUNICIPALITIES = {
    'Barrancabermeja': (-73.85, 7.07),
    'Puerto Berrío': (-74.40, 6.49),
    'San Pablo': (-73.92, 7.48),
    'Cimitarra': (-73.95, 6.32),
    'Yondó': (-74.00, 6.85),
}
...
def map01_study_area(data):
    ...
    ax1.add_patch(rect)
    ax1.annotate('Magdalena\nMedio', xy=(-74.25, 7.0), fontsize=7,
